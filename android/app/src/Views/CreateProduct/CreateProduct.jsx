...
function CreateProduct({navigation}) {
  ...
  const [foodDescription, setFoodDsecription] = useState();
  const [foodAvailable, setFoodAvailable] = useState(true);
  const [foodPriceSmall, setFoodPriceSmall] = useState(null);
  const [foodPriceAverage, setFoodPriceAverage] = useState(null);
  const [foodPriceLarge, setFoodPriceLarge] = useState(null);
  const [foodPriceUnique, setFoodPriceUnique] = useState(null);
